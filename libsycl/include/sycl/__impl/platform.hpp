...
public:
  ...
  /// Returns all SYCL platforms from all backends that are available in the system.
  ///
  /// \return A std::vector containing all of the platforms from all backends that are available in the system.
